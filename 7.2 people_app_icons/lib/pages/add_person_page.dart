...
class _AddPersonPageState extends State<AddPersonPage> {
  ...
  late StreamSubscription _onBeforeUnloadSubscription;

  @override
  void initState() {
    _onBeforeUnloadSubscription = html.window.onBeforeUnload.listen((event) {
      if (_firstNameController.text.isNotEmpty ||
        ...
        const errorMessage = 'You haven\'t saved the person yet!';

        (event as html.BeforeUnloadEvent).returnValue = errorMessage;
      }
    });
  ...
  void dispose() async {
    ...
    await _onBeforeUnloadSubscription.cancel();
